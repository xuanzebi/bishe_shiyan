...
OUTPUT_DIR="/opt/hyp/NER/Cysecurity_pretrain/fine-tune/save_models/cyber/sda_step_mlm_cys_step${sda_step_kd}_alpha${alpha}_epoch${max_epoch}_LR${LR}_BATCH_SIZE${BATCH_SIZE}/"
